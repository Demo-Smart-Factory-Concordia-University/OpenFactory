...
class Test_OfaInfraUp(TestCase):
    """
    Unit tests for ofa.infra.up function
    """
    ...
    def test_setup_base_stack(self, *args):
        ...
        ofa.infra.up(db.session, config_file)
    ...
    def test_extend_stack(self, *args):
        ...
        self.assertRaises(OFAConfigurationException, ofa.infra.up, db.session, config_file)
        # conflict in network
        config_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),

...
@patch("openfactory.factories.deploy_apps.ksql")
class TestDeployAppsFromConfigFile(unittest.TestCase):
    """
    Test deployment of apps based on a yaml_config_file
    """

    def test_deploy_apps_none(self, mock_ksql, mock_notify, mock_manager_cls, mock_get_apps):
        ...
        deploy_apps_from_config_file("fake_config.yaml")
    ...
    def test_deploy_existing_application(self, mock_ksql, mock_notify, mock_manager_cls, mock_get_apps):
    ...
    def test_deploy_new_application(self, mock_ksql, mock_notify, mock_manager_cls, mock_get_apps):
